...
const AppContent = () => {
  ...
  return (
    <div className="overflow-x-hidden font-sans">
      <Navbar lang={lang} setLang={setLang} currentView={currentView as any} setView={setView} t={t} userRole={userRole} />
      ...
      <BookClassModal lang={lang} t={t} isOpen={showBookModal} onClose={() => setShowBookModal(false)} />
      <AddChildModal
        lang={lang}
        t={t}
