...
export const translations: Record<'ar' | 'en', Translations> = {
  ar: {
    ...
    profile: {
      ...
      myself: "أنا (ولي الأمر)",
      childDashboard: "بوابة الطالب",
      welcomeBack: "مرحباً بك مجدداً",
      nextLesson: "درسك القادم",
    ...
    reciters: {
      badge: "نخبة القراء",
      title: "تعلم مع أفضل القراء المعتمدين",
      subtitle: "نخبة من المعلمين والمعلمات الحاصلين على إجازات في القراءات العشر من كبار المشايخ.",
      r1Name: "الشيخ محمد أحمد",
      r1Specialty: "إجازة في القراءات العشر",
      r2Name: "الشيخة مريم علي",
      r2Specialty: "متخصصة في القاعدة النورانية",
      r3Name: "الشيخ عبد الله عمر",
      r3Specialty: "باحث في علوم القرآن",
      r4Name: "الشيخة سارة محمود",
      r4Specialty: "إجازة في رواية حفص عن عاصم",
      viewAll: "تصفح جميع القراء",
    },
    steps: {
  ...
  en: {
    ...
    profile: {
      ...
      childDashboard: "Student Dashboard",
    ...
    reciters: {
      badge: "Elite Reciters",
      title: "Learn with Top Certified Reciters",
      subtitle: "A group of male and female teachers with licenses in the ten recitations from senior scholars.",
      r1Name: "Sheikh Mohamed Ahmed",
      r1Specialty: "License in Ten Recitations",
      r2Name: "Sheikha Maryam Ali",
      r2Specialty: "Noorani Qaida Specialist",
      r3Name: "Sheikh Abdullah Omar",
      r3Specialty: "Quranic Sciences Researcher",
      r4Name: "Sheikha Sarah Mahmoud",
      r4Specialty: "License in Hafs from Asim",
      viewAll: "Browse All Reciters",
    },
    steps: {
